...
namespace BilleteraEjercicio.Moldes
{
    internal class Billetera
    {
        ...
        {
            return Convert.ToDecimal(BilletesDe10 * 10 + BilletesDe20 * 20 + BilletesDe50 * 50 + BilletesDe100 * 100 + BilletesDe200 * 200 + BilletesDe500 * 500 + BilletesDe1000 * 1000);
        }
        ...
        private void BilleteraSeca(Billetera billeteraSeca)
        {
            ...
            billeteraSeca.BilletesDe50 = 0;
            billeteraSeca.BilletesDe100 = 0;
            billeteraSeca.BilletesDe200 = 0;
            billeteraSeca.BilletesDe500 = 0;
            billeteraSeca.BilletesDe1000 = 0;
        }
